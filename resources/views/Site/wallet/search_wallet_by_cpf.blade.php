			...
			<div class="container padding_35_35">
				<div id="login">
					<h1>
                        ...
                        <br>
                        <small class="font-12">
                            Digite o número de seu CPF para visualizar a carteirinha virtual.
                        </small>
                    </h1>
					<div class="box_form">
						{!! Form::open(['url'=>route('site.wallet.validate_user')]) !!}
							...
							<div class="form-group text-center add_top_20">
								<input class="btn_1 btn-block medium border-r-0" type="submit" value="Buscar carteirinha digital">
							</div>
						{!! Form::close() !!}
					</div>
