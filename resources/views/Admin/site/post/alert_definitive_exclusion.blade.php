...
@section('title', 'Excluindo notícia permanentemente')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                {!! Form::model($data['post'], ['url' => route('adm.post.definitive_delete')]) !!}
                    {!! Form::hidden('id') !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="text-danger">
                                Após esta exclusão, este registro não poderá ser recuperado
                            </p>
                        </div>
                    </div>
