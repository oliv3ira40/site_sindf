                ...
                {!! Form::model($user, ['url'=>route('adm.users.update')]) !!}
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            {!! Form::number('cpf', null, ['class'=>'form-control', 'id'=>'cpf']) !!}
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            @if ($user->id == \Auth::user()->id)
                                @if (in_array('adm.users.edit_own_group', HelpAdmin::permissionsUser()))
                    ...
                    @if (in_array('adm.user.definitive_password_reset', HelpAdmin::permissionsUser()))
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label for="password" class="col-form-label">
                                    Senha definitiva
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="checkbox checkbox-primary">
                                @if (in_array('adm.user.definitive_password_reset', HelpAdmin::permissionsUser()))
                                    <input id="checkbox1" type="checkbox" name="definitive_password">
                                    <label for="checkbox1" class="m-r-10">
                                        Exigir senha definitiva
                                    </label>
                                @endif
