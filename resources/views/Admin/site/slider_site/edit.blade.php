...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                {!! Form::model($data['slider_site'], ['url'=>route('adm.slider_site.update'), 'files'=>'true']) !!}
                    {!! Form::hidden('id') !!}
                    {{-- {!! Form::hidden('old_img', $data['slider_site']->img) !!} --}}
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="img" class="dropify" data-default-file="{{ asset(HelpAdmin::getStorageUrl().$data['slider_site']->img) }}"/>
                        </div>
